...
typedef enum {
    CHESS_BUTTON_NEW_GAME, CHESS_BUTTON_LOAD, CHESS_BUTTON_QUIT, CHESS_BUTTON_1PLAYER, CHESS_BUTTON_2PLAYER
} ButtonType;

typedef enum {
    CHESS_CLICKED_NEW_GAME, CHESS_CLICKED_LOAD, CHESS_CLICKED_QUIT, CHESS_CLICKED_NONE, CHESS_CLICKED_1PLAYER, CHESS_CLICKED_2PLAYER
} BUTTON_CLICK_EVENT;
