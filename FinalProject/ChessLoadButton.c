...
ChessWidget* createChessLoadButton(SDL_Renderer* windowRender, SDL_Rect* location,
    ...
    ChessLoadButton* data = (ChessLoadButton*) malloc(sizeof(ChessLoadButton));
    ...
    res->destroyWidget = destroyChessLoadButton;
    res->drawWidget = drawChessLoadButton;
    res->handleEvent = handleChessLoadButtonEvenet;
    res->data = data;
    return res;
}

//You need this function in order to destroy all data Associate with a button:
void destroyChessLoadButton(ChessWidget* src) {
    if (src == NULL ) {
        return;
    }
    ChessLoadButton* castData = (ChessLoadButton*) src->data;
...
void handleChessLoadButtonEvenet(ChessWidget* src, SDL_Event* event, ChessWindow* window) {
